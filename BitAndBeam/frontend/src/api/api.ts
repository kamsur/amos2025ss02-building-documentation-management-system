  ...
  return {
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap['AuthApi.authLoginPost']?.[
 ...
 * @export
 */
export const BitAndBeamApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const BitAndBeamApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    BitAndBeamApiAxiosParamCreator(configuration);
  return {
    /**
     *
     * @param {*} [options] Override http request option.
    ...
    > {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BitAndBeamApi.rootGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const BitAndBeamApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class BitAndBeamApi extends BaseAPI {
  ...
  public rootGet(options?: RawAxiosRequestConfig) {
    return BitAndBeamApiFp(this.configuration)
      .rootGet(options)
      .then((request) => request(this.axios, this.basePath));
  }
}
  ...
  return {
    ...
    async apiBuildingsGet(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<Array<BuildingDto>>
    > {
      const localVarAxiosArgs =
    ...
    async apiBuildingsIdGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<BuildingDto>
    > {
      const localVarAxiosArgs =
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiBuildingsPost(
          buildingCreateDto,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const BuildingsApiFactory = function (
  ...
  return {
    ...
    apiBuildingsPost(
      ...
      return localVarFp
        .apiBuildingsPost(buildingCreateDto, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export const DocumentsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiDocumentsCategoriesGet: async (
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    apiDocumentsDocumentIdAskPost: async (
      documentId: number,
      documentChatbotRequest?: DocumentChatbotRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'documentId' is not null or undefined
      assertParamExists(
        'apiDocumentsDocumentIdAskPost',
        'documentId',
        documentId,
      );
      const localVarPath = `/api/Documents/{documentId}/ask`.replace(
        `{${'documentId'}}`,
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdExtractKeyInformationPost: async (
      id: number,
      extractKeyInformationRequest?: ExtractKeyInformationRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('apiDocumentsIdExtractKeyInformationPost', 'id', id);
      const localVarPath =
        `/api/Documents/{id}/extract-key-information`.replace(
          `{${'id'}}`,
          encodeURIComponent(String(id)),
        );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdPatch: async (
      id: number,
      documentMetadataPatchRequest?: DocumentMetadataPatchRequest,
      options: RawAxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
...
export const DocumentsApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsCategoriesGet(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsCategoriesGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsCategoriesGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsDocumentIdAskPost(
      documentId: number,
      documentChatbotRequest?: DocumentChatbotRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<DocumentChatbotResponse>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsDocumentIdAskPost(
          documentId,
          documentChatbotRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsDocumentIdAskPost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async apiDocumentsIdExtractKeyInformationPost(
      id: number,
      extractKeyInformationRequest?: ExtractKeyInformationRequest,
      options?: RawAxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdExtractKeyInformationPost(
          id,
          extractKeyInformationRequest,
          options,
        );
      ...
      const localVarOperationServerBasePath =
        operationServerMap[
          'DocumentsApi.apiDocumentsIdExtractKeyInformationPost'
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiDocumentsIdPatch(
          id,
          documentMetadataPatchRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['DocumentsApi.apiDocumentsIdPatch']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const DocumentsApiFactory = function (
  ...
  return {
    ...
    apiDocumentsCategoriesGet(options?: any): AxiosPromise<void> {
      return localVarFp
        .apiDocumentsCategoriesGet(options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    apiDocumentsIdExtractKeyInformationPost(
      id: number,
      extractKeyInformationRequest?: ExtractKeyInformationRequest,
      options?: any,
    ): AxiosPromise<void> {
    ...
    apiDocumentsIdPatch(
      ...
      return localVarFp
        .apiDocumentsIdPatch(id, documentMetadataPatchRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class DocumentsApi extends BaseAPI {
   ...
   * @memberof DocumentsApi
   */
  public apiDocumentsDocumentIdAskPost(
    documentId: number,
    documentChatbotRequest?: DocumentChatbotRequest,
    options?: RawAxiosRequestConfig,
  ) {
   ...
   * @memberof DocumentsApi
   */
  public apiDocumentsIdExtractKeyInformationPost(
    id: number,
    extractKeyInformationRequest?: ExtractKeyInformationRequest,
    options?: RawAxiosRequestConfig,
  ) {
...
export const OllamaApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiOllamaHealthGet(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiOllamaHealthGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['OllamaApi.apiOllamaHealthGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const TikaApiAxiosParamCreator = function (
  configuration?: Configuration,
) {
  return {
    /**
...
export const TikaApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async apiTikaHealthGet(
      options?: RawAxiosRequestConfig,
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiTikaHealthGet(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TikaApi.apiTikaHealthGet']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.apiTikaProcessPost(file, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['TikaApi.apiTikaProcessPost']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
 ...
 * @export
 */
export const TikaApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    apiTikaProcessPost(file?: File, options?: any): AxiosPromise<void> {
      return localVarFp
        .apiTikaProcessPost(file, options)
        .then((request) => request(axios, basePath));
    },
  };
};
...
export class TikaApi extends BaseAPI {
  ...
  public apiTikaHealthGet(options?: RawAxiosRequestConfig) {
    return TikaApiFp(this.configuration)
      .apiTikaHealthGet(options)
      .then((request) => request(this.axios, this.basePath));
  }
